namespace Terraria
{
    ...
    public class Item
    {
        ...
        public static int[] bodyType = new int[0x1a];
        public int buffTime;
        public int buffType;
        public bool buy;
        public bool buyOnce;
        ...
        public static int[] headType = new int[0x2d];
        public int healLife;
        public int healMana;
        public int height;
        ...
        public static int[] legType = new int[0x19];
        ...
        public bool Prefix(int pre)
        {
            ...
            while (flag)
            {
                ...
                if (((num == -1) || (num == -2)) || (num == -3))
                {
                    ...
                    else if (((((this.type == 0xa2) || (this.type == 160)) || ((this.type == 0xa3) || (this.type == 220))) || (((this.type == 0x112) || (this.type == 0x115)) || ((this.type == 280) || (this.type == 0x17f)))) || ((((this.type == 0x180) || (this.type == 0x181)) || ((this.type == 0x182) || (this.type == 0x183))) || ((((this.type == 0x184) || (this.type == 0x185)) || ((this.type == 390) || (this.type == 0x196))) || (((this.type == 0x219) || (this.type == 550)) || (this.type == 0x243)))))
                    {
                    ...
                    else if (((((this.type == 0x40) || (this.type == 0x41)) || ((this.type == 0x70) || (this.type == 0x71))) || (((this.type == 0x7f) || (this.type == 0x9d)) || ((this.type == 0xa5) || (this.type == 0xda)))) || ((((this.type == 0x110) || (this.type == 0x1ee)) || ((this.type == 0x1ef) || (this.type == 0x1f0))) || (((this.type == 0x202) || (this.type == 0x205)) || ((this.type == 0x206) || (this.type == 0x207)))))
                    {
                        switch (Main.rand.Next(0x24))
                        {
                            case 0:
        ...
        public void SetDefaults(int Type, bool noMatCheck = false)
        {
            ...
            else if (this.type == 0x24a)
            {
                ...
                this.maxStack = 250;
                this.consumable = true;
                this.createTile = 0x91;
                this.width = 12;
                this.height = 12;
            }
            else if (this.type == 0x24b)
            {
                ...
                this.maxStack = 250;
                this.consumable = true;
                this.createWall = 0x1d;
                this.width = 12;
                this.height = 12;
            }
            else if (this.type == 0x24c)
            {
                this.name = "Santa Hat";
                this.width = 0x12;
                this.height = 12;
            ...
            else if (this.type == 0x24f)
            {
                ...
                this.maxStack = 250;
                this.consumable = true;
                this.createTile = 0x92;
                this.width = 12;
                this.height = 12;
            }
            else if (this.type == 0x250)
            {
            ...
            else if (this.type == 0x251)
            {
                ...
                this.maxStack = 250;
                this.consumable = true;
                this.createTile = 0x93;
                this.width = 12;
                this.height = 12;
            }
            else if (this.type == 0x252)
            {
                ...
                this.maxStack = 250;
                this.consumable = true;
                this.createTile = 0x94;
                this.width = 12;
                this.height = 12;
            }
            else if (this.type == 0x253)
            {
            ...
            else if (this.type == 0x254)
            {
                ...
                this.maxStack = 250;
                this.consumable = true;
                this.createTile = 0x95;
                this.placeStyle = 0;
                this.width = 12;
                this.height = 12;
                this.value = 500;
            }
            else if (this.type == 0x255)
            {
                this.name = "Red Light";
                this.useStyle = 1;
                this.useTurn = true;
