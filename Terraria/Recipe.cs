namespace Terraria
{
    ...
    public class Recipe
    {
        ...
        public static void SetupRecipes()
        {
            ...
            newRecipe.requiredTile[0] = 0x11;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x252, false);
            newRecipe.requiredItem[0].SetDefaults(0x251, false);
            newRecipe.requiredItem[0].stack = 2;
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x253, false);
            newRecipe.createItem.stack = 4;
            newRecipe.requiredItem[0].SetDefaults(0x252, false);
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x24b, false);
            newRecipe.createItem.stack = 4;
            newRecipe.requiredItem[0].SetDefaults(0x24a, false);
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x250, false);
            newRecipe.createItem.stack = 4;
            newRecipe.requiredItem[0].SetDefaults(0x24f, false);
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
