namespace Terraria
{
    ...
    public class Chest
    {
        ...
        public void SetupShop(int type)
        {
            ...
            {
                int num10 = 0;
                this.item[num10].SetDefaults(0x24c, false);
                num10++;
                this.item[num10].SetDefaults(0x24d, false);
                num10++;
                this.item[num10].SetDefaults(590, false);
                num10++;
                this.item[num10].SetDefaults(0x255, false);
                num10++;
                this.item[num10].SetDefaults(0x256, false);
                num10++;
                this.item[num10].SetDefaults(0x254, false);
                num10++;
            }
        }
