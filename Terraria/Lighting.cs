            ...
            if (Main.renderCount > maxRenderCount)
            {
                ...
                for (int num43 = firstToLightX; num43 < lastToLightX; num43++)
                {
                    ...
                    Label_258C:
                        ...
                        else if (Main.tile[num43, num44].frameX == 0x12)
                        {
                            num53 = 0.5f;
                            num55 = 0.1f;
                            num54 = 0.1f;
                        ...
                        switch (Main.tile[num43, num44].type)
                        {
                            ...
                            case 0x95:
                                if (Main.tile[num43, num44].frameX <= 0x24)
                                {
                                    ...
                                    {
                                        color2[num45, num46] = (num69 * Main.rand.Next(970, 0x407)) * 0.001f;
                                    }
                                }
                                goto Label_2DE7;
                    ...
                    Label_2DE7:
                        if (Main.tile[num43, num44].lava && (Main.tile[num43, num44].liquid > 0))
                        {
                            if (RGB)
                            {
                                float num70 = ((Main.tile[num43, num44].liquid / 0xff) * 0.41f) + 0.14f;
                                num70 = 0.55f;
                                num70 += ((float) (270 - Main.mouseTextColor)) / 900f;
                                if (color2[num45, num46] < num70)
                                {
                                    color2[num45, num46] = num70;
                                }
                                if (colorG2[num45, num46] < num70)
                                {
                                    colorG2[num45, num46] = num70 * 0.6f;
                                }
                                if (colorB2[num45, num46] < num70)
                                {
                                    colorB2[num45, num46] = num70 * 0.2f;
                                }
                            }
                            else
                            {
                                float num71 = ((Main.tile[num43, num44].liquid / 0xff) * 0.38f) + 0.08f;
                                num71 += ((float) (270 - Main.mouseTextColor)) / 2000f;
                                if (color2[num45, num46] < num71)
                                {
                                    color2[num45, num46] = num71;
                                }
                            }
                        }
