    ...
    public class Projectile
    {
        ...
        public void AI()
        {
            ...
            if (this.aiStyle == 1)
            {
                ...
                if ((((this.type == 20) || (this.type == 14)) || ((this.type == 0x24) || (this.type == 0x53))) || (((this.type == 0x54) || (this.type == 0x59)) || (((this.type == 100) || (this.type == 0x68)) || (this.type == 110))))
                {
                    if (this.alpha > 0)
                    {
                        this.alpha -= 15;
                ...
                if (((((this.type != 5) && (this.type != 14)) && ((this.type != 20) && (this.type != 0x24))) && (((this.type != 0x26) && (this.type != 0x37)) && ((this.type != 0x53) && (this.type != 0x54)))) && ((((this.type != 0x58) && (this.type != 0x59)) && ((this.type != 0x62) && (this.type != 100))) && ((this.type != 0x68) && (this.type != 110))))
                {
                    this.ai[0]++;
                }
        ...
        public void Kill()
        {
            if (this.active)
            {
                ...
                else if ((((this.type == 14) || (this.type == 20)) || ((this.type == 0x24) || (this.type == 0x53))) || (((this.type == 0x54) || (this.type == 100)) || (this.type == 110)))
                {
                ...
                else if (this.type == 0x6d)
                {
                    ...
                    {
                        color = new Color();
                        int num54 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x33, 0f, 0f, 0, color, 0.6f);
                ...
                else if (this.type == 0x27)
                {
                    ...
                    {
                        color = new Color();
                        int num56 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x26, 0f, 0f, 0, color, 1f);
                ...
                else if (this.type == 0x47)
                {
                    ...
                    {
                        color = new Color();
                        int num58 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x35, 0f, 0f, 0, color, 1f);
                ...
                else if (this.type == 40)
                {
                    ...
                    {
                        color = new Color();
                        int num60 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x24, 0f, 0f, 0, color, 1f);
                        Dust dust16 = Main.dust[num60];
                        dust16.velocity = (Vector2) (dust16.velocity * 0.6f);
                    }
                }
                ...
                {
                    Main.PlaySound(2, (int) this.position.X, (int) this.position.Y, 10);
                    for (int num63 = 0; num63 < 30; num63++)
                    {
                        color = new Color();
                        int num64 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x1d, this.velocity.X * 0.1f, this.velocity.Y * 0.1f, 100, color, 3f);
                ...
                {
                    Main.PlaySound(2, (int) this.position.X, (int) this.position.Y, 10);
                    for (int num66 = 0; num66 < 30; num66++)
                    {
                        color = new Color();
                        int num67 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x1b, this.velocity.X, this.velocity.Y, 100, color, 1.7f);
                ...
                else
                {
                    ...
                    if (this.type == 0x29)
                    {
                        ...
                        {
                            color = new Color();
                            int num70 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, color, 2.5f);
                            Main.dust[num70].noGravity = true;
                            Dust dust17 = Main.dust[num70];
                            dust17.velocity = (Vector2) (dust17.velocity * 3f);
                            color = new Color();
                            num70 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, color, 1.5f);
                            Dust dust18 = Main.dust[num70];
                            dust18.velocity = (Vector2) (dust18.velocity * 2f);
                        }
                        vector2 = new Vector2();
                        int num71 = Gore.NewGore(new Vector2(this.position.X, this.position.Y), vector2, Main.rand.Next(0x3d, 0x40), 1f);
                        Gore gore1 = Main.gore[num71];
                        gore1.velocity = (Vector2) (gore1.velocity * 0.4f);
                        Main.gore[num71].velocity.X += Main.rand.Next(-10, 11) * 0.1f;
                        Main.gore[num71].velocity.Y += Main.rand.Next(-10, 11) * 0.1f;
                        num71 = Gore.NewGore(new Vector2(this.position.X, this.position.Y), new Vector2(), Main.rand.Next(0x3d, 0x40), 1f);
                        Gore gore2 = Main.gore[num71];
                    ...
                    else if (((this.type == 0x1c) || (this.type == 30)) || (((this.type == 0x25) || (this.type == 0x4b)) || (this.type == 0x66)))
                    {
                        ...
                        {
                            color = new Color();
                            int num73 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x1f, 0f, 0f, 100, color, 1.5f);
                            Dust dust19 = Main.dust[num73];
                            dust19.velocity = (Vector2) (dust19.velocity * 1.4f);
                        }
                        for (int num74 = 0; num74 < 10; num74++)
                        {
                            color = new Color();
                            int num75 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, color, 2.5f);
                            Main.dust[num75].noGravity = true;
                            Dust dust20 = Main.dust[num75];
                            dust20.velocity = (Vector2) (dust20.velocity * 5f);
                            color = new Color();
                            num75 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, color, 1.5f);
                            Dust dust21 = Main.dust[num75];
                            dust21.velocity = (Vector2) (dust21.velocity * 3f);
                        }
                        vector2 = new Vector2();
                        int num76 = Gore.NewGore(new Vector2(this.position.X, this.position.Y), vector2, Main.rand.Next(0x3d, 0x40), 1f);
                        Gore gore3 = Main.gore[num76];
                        gore3.velocity = (Vector2) (gore3.velocity * 0.4f);
                        Main.gore[num76].velocity.X++;
                        Main.gore[num76].velocity.Y++;
                        vector2 = new Vector2();
                        num76 = Gore.NewGore(new Vector2(this.position.X, this.position.Y), vector2, Main.rand.Next(0x3d, 0x40), 1f);
                        Gore gore4 = Main.gore[num76];
                        gore4.velocity = (Vector2) (gore4.velocity * 0.4f);
                        Main.gore[num76].velocity.X--;
                        Main.gore[num76].velocity.Y++;
                        vector2 = new Vector2();
                        num76 = Gore.NewGore(new Vector2(this.position.X, this.position.Y), vector2, Main.rand.Next(0x3d, 0x40), 1f);
                        Gore gore5 = Main.gore[num76];
                        gore5.velocity = (Vector2) (gore5.velocity * 0.4f);
                        Main.gore[num76].velocity.X++;
                        Main.gore[num76].velocity.Y--;
                        num76 = Gore.NewGore(new Vector2(this.position.X, this.position.Y), new Vector2(), Main.rand.Next(0x3d, 0x40), 1f);
                        Gore gore6 = Main.gore[num76];
                    ...
                    else if ((this.type == 0x1d) || (this.type == 0x6c))
                    {
                        ...
                        {
                            color = new Color();
                            int num78 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x1f, 0f, 0f, 100, color, 2f);
                            Dust dust22 = Main.dust[num78];
                            dust22.velocity = (Vector2) (dust22.velocity * 1.4f);
                        }
                        for (int num79 = 0; num79 < 80; num79++)
                        {
                            color = new Color();
                            int num80 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, color, 3f);
                            Main.dust[num80].noGravity = true;
                            Dust dust23 = Main.dust[num80];
                            dust23.velocity = (Vector2) (dust23.velocity * 5f);
                            color = new Color();
                            num80 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, color, 2f);
                            Dust dust24 = Main.dust[num80];
                            dust24.velocity = (Vector2) (dust24.velocity * 3f);
                        }
                        for (int num82 = 0; num82 < 2; num82++)
                        {
                            vector2 = new Vector2();
                            int num81 = Gore.NewGore(new Vector2((this.position.X + (this.width / 2)) - 24f, (this.position.Y + (this.height / 2)) - 24f), vector2, Main.rand.Next(0x3d, 0x40), 1f);
                            Main.gore[num81].scale = 1.5f;
                            Main.gore[num81].velocity.X += 1.5f;
                            Main.gore[num81].velocity.Y += 1.5f;
                            vector2 = new Vector2();
                            num81 = Gore.NewGore(new Vector2((this.position.X + (this.width / 2)) - 24f, (this.position.Y + (this.height / 2)) - 24f), vector2, Main.rand.Next(0x3d, 0x40), 1f);
                            Main.gore[num81].scale = 1.5f;
                            Main.gore[num81].velocity.X -= 1.5f;
                            Main.gore[num81].velocity.Y += 1.5f;
                            vector2 = new Vector2();
                    ...
                    else if (this.type == 0x45)
                    {
                        ...
                        {
                            color = new Color();
                            int num85 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x21, 0f, -2f, 0, color, 1.1f);
                            Main.dust[num85].alpha = 100;
                            Main.dust[num85].velocity.X *= 1.5f;
                            Dust dust25 = Main.dust[num85];
                    ...
                    else if (this.type == 70)
                    {
                        ...
                        {
                            color = new Color();
                            int num88 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x34, 0f, -2f, 0, color, 1.1f);
                            Main.dust[num88].alpha = 100;
                            Main.dust[num88].velocity.X *= 1.5f;
                            Dust dust26 = Main.dust[num88];
                ...
                if (this.owner == Main.myPlayer)
                {
                    if (((this.type == 0x1c) || (this.type == 0x1d)) || (((this.type == 0x25) || (this.type == 0x4b)) || (this.type == 0x6c)))
                    {
                        ...
                        int num90 = ((int) (this.position.X / 16f)) - num89;
                        int maxTilesX = ((int) (this.position.X / 16f)) + num89;
                        int num92 = ((int) (this.position.Y / 16f)) - num89;
                        int maxTilesY = ((int) (this.position.Y / 16f)) + num89;
                        if (num90 < 0)
                        {
                            num90 = 0;
                        }
                        ...
                        bool flag = false;
                        for (int num94 = num90; num94 <= maxTilesX; num94++)
                        {
                            for (int num95 = num92; num95 <= maxTilesY; num95++)
                            {
                                float num96 = Math.Abs((float) (num94 - (this.position.X / 16f)));
                                float num97 = Math.Abs((float) (num95 - (this.position.Y / 16f)));
                                if (((Math.Sqrt((double) ((num96 * num96) + (num97 * num97))) < num89) && (Main.tile[num94, num95] != null)) && (Main.tile[num94, num95].wall == 0))
                                {
                                    flag = true;
                                    goto Label_2D69;
                                }
                        ...
                        for (int num99 = num90; num99 <= maxTilesX; num99++)
                        {
                            for (int num100 = num92; num100 <= maxTilesY; num100++)
                            {
                                float num101 = Math.Abs((float) (num99 - (this.position.X / 16f)));
                                float num102 = Math.Abs((float) (num100 - (this.position.Y / 16f)));
                                if (Math.Sqrt((double) ((num101 * num101) + (num102 * num102))) < num89)
                                {
                                    bool flag2 = true;
                                    if ((Main.tile[num99, num100] != null) && Main.tile[num99, num100].active)
                                    {
                                        flag2 = true;
                                        if (((Main.tileDungeon[Main.tile[num99, num100].type] || (Main.tile[num99, num100].type == 0x15)) || ((Main.tile[num99, num100].type == 0x1a) || (Main.tile[num99, num100].type == 0x6b))) || ((Main.tile[num99, num100].type == 0x6c) || (Main.tile[num99, num100].type == 0x6f)))
                                        {
                                            flag2 = false;
                                        }
                                        if (!Main.hardMode && (Main.tile[num99, num100].type == 0x3a))
                                        {
                                            flag2 = false;
                                        }
                                        if (flag2)
                                        {
                                            WorldGen.KillTile(num99, num100, false, false, false);
                                            if (!Main.tile[num99, num100].active && (Main.netMode != 0))
                                            {
                                                NetMessage.SendData(0x11, -1, -1, "", 0, (float) num99, (float) num100, 0f, 0);
                                            }
                                        }
                                    }
                                    if (flag2)
                                    {
                                        for (int num104 = num99 - 1; num104 <= (num99 + 1); num104++)
                                        {
                                            for (int num105 = num100 - 1; num105 <= (num100 + 1); num105++)
                                            {
                                                if (((Main.tile[num104, num105] != null) && (Main.tile[num104, num105].wall > 0)) && flag)
                                                {
                                                    WorldGen.KillWall(num104, num105, false);
                                                    if ((Main.tile[num104, num105].wall == 0) && (Main.netMode != 0))
                                                    {
                                                        NetMessage.SendData(0x11, -1, -1, "", 2, (float) num104, (float) num105, 0f, 0);
                                                    }
                                                }
                                            }
                                        }
                    ...
                    if (this.aiStyle == 10)
                    {
                        int num107 = (((int) this.position.X) + (this.width / 2)) / 0x10;
                        int num108 = (((int) this.position.Y) + (this.width / 2)) / 0x10;
                        int num109 = 0;
                        int num110 = 2;
                        if (this.type == 0x6d)
                        {
                        ...
                        {
                            WorldGen.PlaceTile(num107, num108, num109, false, true, -1, 0);
                            if (Main.tile[num107, num108].active && (Main.tile[num107, num108].type == num109))
                            {
                                NetMessage.SendData(0x11, -1, -1, "", 1, (float) num107, (float) num108, (float) num109, 0);
                            }
                            else if (num110 > 0)
                            {
                                number = Item.NewItem((int) this.position.X, (int) this.position.Y, this.width, this.height, num110, 1, false, 0);
                            }
                        }
                        else if (num110 > 0)
                        {
                    ...
                    if ((this.type == 0x45) || (this.type == 70))
                    {
                        int num111 = (((int) this.position.X) + (this.width / 2)) / 0x10;
                        int num112 = (((int) this.position.Y) + (this.height / 2)) / 0x10;
                        for (int num113 = num111 - 4; num113 <= (num111 + 4); num113++)
                        {
                            for (int num114 = num112 - 4; num114 <= (num112 + 4); num114++)
                            {
                                if ((Math.Abs((int) (num113 - num111)) + Math.Abs((int) (num114 - num112))) < 6)
                                {
                                    if (this.type == 0x45)
                                    {
                                        if (Main.tile[num113, num114].type == 2)
                                        {
                                            Main.tile[num113, num114].type = 0x6d;
                                            WorldGen.SquareTileFrame(num113, num114, true);
                                            NetMessage.SendTileSquare(-1, num113, num114, 1);
                                        }
                                        else if (Main.tile[num113, num114].type == 1)
                                        {
                                            Main.tile[num113, num114].type = 0x75;
                                            WorldGen.SquareTileFrame(num113, num114, true);
                                            NetMessage.SendTileSquare(-1, num113, num114, 1);
                                        }
                                        else if (Main.tile[num113, num114].type == 0x35)
                                        {
                                            Main.tile[num113, num114].type = 0x74;
                                            WorldGen.SquareTileFrame(num113, num114, true);
                                            NetMessage.SendTileSquare(-1, num113, num114, 1);
                                        }
                                        else if (Main.tile[num113, num114].type == 0x17)
                                        {
                                            Main.tile[num113, num114].type = 0x6d;
                                            WorldGen.SquareTileFrame(num113, num114, true);
                                            NetMessage.SendTileSquare(-1, num113, num114, 1);
                                        }
                                        else if (Main.tile[num113, num114].type == 0x19)
                                        {
                                            Main.tile[num113, num114].type = 0x75;
                                            WorldGen.SquareTileFrame(num113, num114, true);
                                            NetMessage.SendTileSquare(-1, num113, num114, 1);
                                        }
                                        else if (Main.tile[num113, num114].type == 0x70)
                                        {
                                            Main.tile[num113, num114].type = 0x74;
                                            WorldGen.SquareTileFrame(num113, num114, true);
                                            NetMessage.SendTileSquare(-1, num113, num114, 1);
                                    ...
                                    else if (Main.tile[num113, num114].type == 2)
                                    {
                                        Main.tile[num113, num114].type = 0x17;
                                        WorldGen.SquareTileFrame(num113, num114, true);
                                        NetMessage.SendTileSquare(-1, num113, num114, 1);
                                    }
                                    else if (Main.tile[num113, num114].type == 1)
                                    {
                                        Main.tile[num113, num114].type = 0x19;
                                        WorldGen.SquareTileFrame(num113, num114, true);
                                        NetMessage.SendTileSquare(-1, num113, num114, 1);
                                    }
                                    else if (Main.tile[num113, num114].type == 0x35)
                                    {
                                        Main.tile[num113, num114].type = 0x70;
                                        WorldGen.SquareTileFrame(num113, num114, true);
                                        NetMessage.SendTileSquare(-1, num113, num114, 1);
                                    }
                                    else if (Main.tile[num113, num114].type == 0x6d)
                                    {
                                        Main.tile[num113, num114].type = 0x17;
                                        WorldGen.SquareTileFrame(num113, num114, true);
                                        NetMessage.SendTileSquare(-1, num113, num114, 1);
                                    }
                                    else if (Main.tile[num113, num114].type == 0x75)
                                    {
                                        Main.tile[num113, num114].type = 0x19;
                                        WorldGen.SquareTileFrame(num113, num114, true);
                                        NetMessage.SendTileSquare(-1, num113, num114, 1);
                                    }
                                    else if (Main.tile[num113, num114].type == 0x74)
                                    {
                                        Main.tile[num113, num114].type = 0x70;
                                        WorldGen.SquareTileFrame(num113, num114, true);
                                        NetMessage.SendTileSquare(-1, num113, num114, 1);
